		...
		<div class="wrapper">
						...
						<ul id="iq-sidebar-toggle" class="iq-menu">
							<li class="active active-menu">
								<a
									...
									><i class="las la-home iq-arrow-left"></i><span>Shop</span
								...
								>
									<li>
										<a href="index.html"
											><i class="las la-house-damage"></i>Home Page</a
										>
									</li>
									<li class="active">
										<a href="category.html"
											><i class="ri-function-line"></i>Category Page</a
										>
									</li>
									<li>
										<a href="book-page.html"
											><i class="ri-book-line"></i>Book Page</a
										>
									</li>
									<li>
										<a href="book-pdf.html"
											><i class="ri-file-pdf-line"></i>Book PDF</a
										>
									</li>
									<li>
								...
								>
									...
									<li>
										<a href="admin-category.html"
											><i class="ri-list-check-2"></i>Category Lists</a
										>
									</li>
									<li>
										<a href="admin-author.html"
											><i class="ri-file-user-line"></i>Author</a
										>
									</li>
									<li>
										<a href="admin-books.html"
											><i class="ri-book-2-line"></i>Books</a
										>
									</li>
								</ul>
							</li>
							...
							<ul class="navbar-nav ml-auto navbar-list">
								...
								<li class="line-height pt-3">
									...
									>
										...
										/>
										<div class="caption">
											<h6 class="mb-1 line-height"><%=user.getName() %></h6>
			...
			<div id="content-page" class="content-page">
				<div class="container-fluid">
					<div class="col-lg-12">
						<div class="d-flex justify-content-between align-items-center position-relative mb-0 similar-detail ">
									<div >
           ...
           <li class="col-md-3 mb-5">
											<div class="d-flex align-items-center">
												<div
													class="col-5 p-0 position-relative image-overlap-shadow"
												>
													...
													<div class="view-book">
														<a
															href="/Web/detail?id=<%=product.getMasp()%>"
